...
impl Map {
	...
	let absname = format!("{}{}", CONFIG.map_dir(), self.fname);
...
mod tests {
    ...
    #[test]
    fn new_from_fname() {
	let _ = Map::new("testdata/6700_4_10m_z33.tif", "");
    }
	...
	let h = m.hashes();
	let s = HashSet::from([7730294, 7140317, 7580295, 7600324, 7930241, 7340239, 7900279,
